import numpy as np
import torch as th
from dgl.data import CoraGraphDataset, CiteseerGraphDataset, PubmedGraphDataset, AmazonCoBuyPhotoDataset, AmazonCoBuyComputerDataset, CoauthorCSDataset, CoauthorPhysicsDataset
